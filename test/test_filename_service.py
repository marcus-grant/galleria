...
class TestIntegration:
    ...
    def test_wedding_collection_canon_r5_nyc(self):
        ...
        expected_parts = ["wedding-", "20240615T163000", "-r5a-0.jpg"]
    ...
    def test_generate_unique_sequence_numbers(self):
        ...
        for i in range(3):
            ...
            filename = generate_photo_filename(
                photo, "wedding", existing_filenames=existing_filenames
            )
...
class TestBase32CounterSystem:
    ...
    def test_base32_counter_burst_sequence(self):
        ...
        for i in range(5):
            ...
            filename = generate_photo_filename(
                photo, existing_filenames=existing_filenames
            )
            filenames.append(filename)
            existing_filenames.add(filename)
    ...
    def test_subsecond_ordering_hierarchy(self):
        ...
        # The counter suffix is expected to follow the sort hierarchy:
        # -r5a-0 IMG_002.jpg, subsecond=123
        # -r5a-1 IMG_003.jpg, microseconds=456
        # -r5a-2 IMG_001.jpg, microseconds=789
        # -r5a-3 DSC_0100.jpg, filename hint
        # -r5a-4 DSC_0101.jpg, filename hint
        # Mapping a result back to its original is not asserted here.
