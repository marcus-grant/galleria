...
def test_template_renderer_generates_pics_base_url_for_dual_bucket():
    ...
    with patch('galleria.services.template_renderer.settings') as mock_settings:
        ...
        with patch('galleria.services.template_renderer.is_dual_bucket_configured', return_value=True):
            mock_template = Mock()
            mock_template.render.return_value = "<html>Gallery HTML</html>"
...
def test_template_renderer_generates_pics_base_url_for_single_bucket():
    ...
    with patch('galleria.services.template_renderer.settings') as mock_settings:
        ...
        with patch('galleria.services.template_renderer.is_dual_bucket_configured', return_value=False):
            mock_template = Mock()
            mock_template.render.return_value = "<html>Gallery HTML</html>"
