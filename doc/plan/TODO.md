...
3. Click-to-preview.
   ...
   Prior design exists in doc/TODO.md (AlpineJS component structure and photo
   modal navigation); use it as the starting point.
...
4. Pagination and progressive scroll.
   ...
   this PR.
   Prior design for dynamic loading exists in doc/TODO.md.
